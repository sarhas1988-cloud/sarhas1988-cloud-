    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {post.cover_url && (
            <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-gold-hairline mb-10">
          ...
          <div className="border-t border-gold-hairline mt-14 pt-10 text-center">
            <Link href="/blog" className="inline-block bg-ember text-white px-8 py-3 rounded-lg font-tajawal font-semibold hover:bg-ember/90 transition-colors">
              عودة للمدونة
            </Link>
          </div>
        </div>
