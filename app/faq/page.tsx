...
const faqs = [
  {
    ...
    a: 'كاتب مصري وصيدلي إكلينيكي ومحاضر في الصيدلة الإكلينيكية. يكتب في أدب الثريلر النفسي والرعب، وأعماله تمزج بين الأساطير المصرية القديمة والرعب الحديث.',
  },
  {
  ...
  },
  {
    ...
    a: 'الروايات موجّهة للقرّاء البالغين (١٦+) نظراً لطبيعة المحتوى الذي يتناول موضوعات الرعب والثريلر النفسي.',
  },
]
